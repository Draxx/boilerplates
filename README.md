...
```bash
lambda-typescript-boilerplate$ sam build
```
...
```bash
lambda-typescript-boilerplate$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
lambda-typescript-boilerplate$ sam local start-api
lambda-typescript-boilerplate$ curl http://localhost:3000/
```
...
```bash
lambda-typescript-boilerplate$ sam logs -n HelloWorldFunction --stack-name lambda-typescript-boilerplate --tail
```
...
```bash
lambda-typescript-boilerplate$ cd hello-world
